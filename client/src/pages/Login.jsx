...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="mt-2 w-full h-11 rounded-full text-white bg-gradient-to-r from-[#6366F1] to-[#22C55E] hover:opacity-90 transition"
      >
        {state === "login" ? "Login" : "Sign up"}
      </button>
      ...
      >
        ...
        <span className="text-emerald-400 hover:underline ml-1">
          click here
        </span>
      </p>
    </form>
